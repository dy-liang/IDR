...
_ACTION_REPEAT = {
    'dmc.ball_in_cup.catch': 4, 'dmc.cartpole.swingup': 8,'dmc.cartpole.swingup_sparse': 4, 'dmc.cheetah.run': 4,'dmc.humanoid.stand':4,
    'dmc.finger.spin': 2, 'dmc.reacher.easy': 4, 'dmc.walker.walk': 2,'dmc.walker.stand': 4,'dmc.hopper.stand': 4,'dmc.humanoid.run':4,
    'dmc.humanoid.walk':4,'dmc.walker.run':4,'dmc.finger.turn_hard':2,'dmc.finger.turn_easy':2, 'dmc.hopper.hop':4, 'dmc.cartpole.balance':8,
    'dmc.pendulum.swingup':8, 'dmc.cartpole.balance_sparse':8
}
