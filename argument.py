...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='old-action')
    ...
    #Aux repr:
    parser.add_argument('--aux_mode', default=None, choices=[None, 'a+x*sr', 'a+int*sr', 'a+c*sr', 'r+a+s', 'pad','ras+fourier'], type=str)
    parser.add_argument('--save_source_code', default=True, action='store_true')
    parser.add_argument('--cof_aux', default=0.06, type=float)
