...
def init_auxiliary_task(AUXLILIARY, aux_mode, cof_aux, action_shape, aux_config, device):
    return None if AUXLILIARY is None \
        else AUXLILIARY(aux_mode=aux_mode, cof_aux=cof_aux, action_shape=action_shape, device=device, **aux_config)
